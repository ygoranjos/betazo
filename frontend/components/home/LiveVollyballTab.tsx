...
const LiveVollyballTab = ({ thead = true }: { thead?: boolean }) => {
  const { liveMatches, isLoading } = useSportMatches('volleyball');
    ...
    <>
      ...
      <div className="table__wrap">
        ...
        {!isLoading && liveMatches.length === 0 && (
          <EmptyRow message="Nenhum jogo de vôlei ao vivo no momento." />
        )}

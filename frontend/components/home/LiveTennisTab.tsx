...
const LiveTennisTab = ({ thead = true }: { thead?: boolean }) => {
  const { liveMatches, isLoading } = useSportMatches('tennis');
    ...
    <>
      ...
      <div className="table__wrap">
        ...
        {!isLoading && liveMatches.length === 0 && (
          <EmptyRow message="Nenhum jogo de tênis ao vivo no momento." />
        )}
        ...
        <div className="table__footer">
          <Link href="#0" className="lobby">All Tennis Live</Link>
